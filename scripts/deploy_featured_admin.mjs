/** Deploy «Más pedidos» admin + site featuredSkus support */
import fs from 'fs';
...
const FILES = [
  ...
  'deploy/wp-content/mu-plugins/tuexhibidor-site-manager/assets/admin.css',
];
...
console.log(`\nDeploy featured admin: ${ok} OK, ${fail} fallos`);
